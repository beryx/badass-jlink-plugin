...
----
- delete <span class="purple">jlinkBasePath</span>
- delete <span class="teal"><b>jlinkJarsDir</b></span>
- delete <span class="red">nonModularJarsDir</span>
...
[subs="attributes",options="nowrap"]
----
- archive <span class="maron">mergedJarsDir</span> into <span class="aqua">tmpMergedModuleDir</span>/<i>mergedModuleName</i>.jar
...
- copy the merged jar into <span class="teal">jlinkJarsDir</span>
        (the copied jar will have the path: <i>mergedModuleJar</i>)
- insert the module-info.class from <span class="fuchsia">tmpModuleInfoDir</span> into <i>mergedModuleJar</i>
----
