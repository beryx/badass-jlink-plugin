...
WARNING: The current version of this plugin requires Java 17 and Gradle 8.14.4 or newer.
While it might work with some combinations of older Java and Gradle versions, these are not officially supported.
If you are forced to use Gradle older than 8.14.4, use https://badass-jlink-plugin.beryx.org/releases/3.2.1/[version 3.2.1] of this plugin.
For Gradle versions older than 7.0, use https://badass-jlink-plugin.beryx.org/releases/2.25.0/[version 2.25.0].
