...
It also lets you create an application installer with the https://docs.oracle.com/en/java/javase/14/docs/specs/man/jpackage.html[jpackage] tool introduced in Java 14.
